...
class HistoricoTelevisao extends StatefulWidget {
  const HistoricoTelevisao({ Key? key }) : super(key: key);

  @override
  _HistoricoTelevisaoState createState() => _HistoricoTelevisaoState();
}

class _HistoricoTelevisaoState extends State<HistoricoTelevisao> {
late final userController = Provider.of<UserController>(
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text('Histórico Televisões '),
      ),
