...
class HistoricoCelulares extends StatefulWidget {
  const HistoricoCelulares({ Key? key }) : super(key: key);

  @override
  _HistoricoCelularesState createState() => _HistoricoCelularesState();
}

class _HistoricoCelularesState extends State<HistoricoCelulares> {
