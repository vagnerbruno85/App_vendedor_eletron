...
class HistoricoPromocao extends StatefulWidget {
  const HistoricoPromocao({ Key? key }) : super(key: key);

  @override
  _HistoricoPromocaoState createState() => _HistoricoPromocaoState();
}

class _HistoricoPromocaoState extends State<HistoricoPromocao> {
